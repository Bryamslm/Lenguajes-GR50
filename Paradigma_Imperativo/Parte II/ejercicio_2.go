...
func main() {
	...
	listaPersonas = append(listaPersonas, persona{"Pedro", [10]int{1,2,3,4,5,6,7,10,11}})
	listaPersonas = append(listaPersonas, persona{"Maria", [10]int{1,2,3,4,5,6,7,10,11,12}})
